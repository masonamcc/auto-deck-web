...
import {signInUser} from "../scripts/userScripts.js";
...
export default function Navbar() {
    ...
    return (
        <div className={authUser ? 'navbar gunmetal' : 'navbar'}
            ...
            {authUser ? (
                ...
                <div className={'fullwidth grid-2-col'} style={{alignItems: 'center', display: 'flex'}}>
                    <div style={{width: '50%', alignContent: 'center', display: 'flex'}}>
                        <div className={'flex gap-half'} style={{flex: .2, paddingLeft: '2rem'}}>
                            <h4 onClick={() => setView('welcome')}
                                style={{alignContent: 'center', fontWeight: '700', margin: 0}}>{brand.name}</h4>
                        </div>
                        <div className={'pl-2'}>
                    ...
                    <div style={{width: '50%', textAlign: 'right'}}>
                        ...
                        <div style={{textAlign: 'right', width: 'auto', paddingRight: '2rem'}}
                             >
                ...
                <div className={'fullwidth grid-2-col height-full'} style={{alignItems: 'center', display: 'flex', color: 'black'}}>
                    <div style={{width: '50%', alignContent: 'center', display: 'flex'}}>
                    ...
                    <div style={{width: '50%', textAlign: 'right'}}>
                        ...
                        <div style={{textAlign: 'right', width: 'auto', paddingRight: '2rem'}}>
                            <button className={'button-accent'} onClick={() => setView('sign-in')}>Sign In</button>
                        </div>
                    </div>
